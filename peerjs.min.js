(() => {
  ...
  function U(e) {
    ...
    e.RTCPeerConnection.prototype.getStats = function () {
      ...
      if (arguments.length > 0 && "function" == typeof e)
        return t.apply(this, arguments); // When spec-style getStats is supported, return those when called with
    ...
    Object.defineProperty(e.RTCPeerConnection.prototype, "localDescription", {
      ...
      (e.RTCPeerConnection.prototype.removeTrack = function (e) {
        ...
        (this._streams = this._streams || {}),
          ...
          t &&
            (1 === t.getTracks().length // takes care of any shimmed _senders.
    ...
    (e.navigator.mediaDevices &&
      ...
      (e.navigator.mediaDevices.getDisplayMedia = function (n) {
        if (!(n && n.video)) {
          ...
          return (
            (e.name = "NotFoundError"), // from https://heycam.github.io/webidl/#idl-DOMException-error-names
            (e.code = 8),
            Promise.reject(e)
          );
        }
  ...
  function es(e) {
    if ("object" == typeof e && e.RTCPeerConnection) {
      if (
        ...
        (e.RTCPeerConnection.prototype.addStream = function (e) {
          this._localStreams || (this._localStreams = []),
            this._localStreams.includes(e) || this._localStreams.push(e), // Try to emulate Chrome's behaviour of adding in audio-video order.
  ...
  function eb(e) {
    if (
      ...
      return; // Note: Although Firefox >= 57 has a native implementation, the maximum
  ...
  (ey.generateIdentifier = function () {
    ...
    (ey.parseRtpMap = function (e) {
      ...
      return (
        ...
        (n.channels = 3 === t.length ? parseInt(t[2], 10) : 1), // legacy alias, got renamed back to channels in ORTC.
          ...
          return (
            n.mozGetUserMedia
              ...
              : n.webkitGetUserMedia ||
                (!1 === e.isSecureContext && e.webkitRTCPeerConnection) // Chrome, Chromium, Webview, Opera.
  ...
  class eV {
    ...
    /** Set up various WebRTC listeners. */ _setupListeners(e) {
    ...
    /** Handle an SDP. */ async handleSDP(e, t) {
    ...
    /** Handle a candidate. */ async handleCandidate(e) {
  ...
  class eX extends eH {
    ...
    /**
     * Exposed functionality for users.
     */ /** Allows user to close connection. */ close(e) {
      if (e?.flush) {
    ...
    /** Allows user to send data. */ send(e, t = !1) {
      if (!this.open) {
        this.emitError(
          x.NotOpenYet,
  ...
  class e1 extends eG {
    ...
    /** Initialize a connection with the server. */ _initialize(e) {
      (this._id = e), this.socket.start(e, this._options.token);
    }
    /** Handles messages from the server. */ _handleMessage(e) {
      let t = e.type,
        n = e.payload,
        r = e.src;
      switch (t) {
    ...
    /** Add a data/media connection to this peer. */ _addConnection(e, t) {
    ...
    /** Retrieve a data/media connection for this peer. */ getConnection(e, t) {
    ...
    /** Closes all connections to this peer. */ _cleanupPeer(e) {
